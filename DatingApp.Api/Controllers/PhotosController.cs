...
namespace DatingApp.Api.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> AddPhotoUser(int userId, [FromForm] PhotoForCreationDto photoForCreation)
        {
        ...
        {
            var ptotoFromRepo = await _repository.GetPhoto(id);

            var photo = _mapper.Map<PhotoForReturnDto>(ptotoFromRepo);
